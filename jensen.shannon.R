jensen.shannon <- function(p1, p2){
    ...
    # a case, it is possible due to rounding errors, that the log(p1/p) or log(02/p)
    # is almost zero (e-15) but from the zero side and that will screw up the 
    # sqrt afterwards
